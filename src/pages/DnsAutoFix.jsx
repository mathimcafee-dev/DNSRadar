        ...
        <div style={{ ...card, marginBottom:16, border:'1px solid rgba(245,158,11,0.25)' }}>
          ...
          <div style={{ padding:16 }}>
              ...
              <div key={f.key} style={{ marginBottom:12 }}>
                ...
                <div style={{ position:'relative' }}>
                  <input
                    ...
                    style={{ width:'100%', padding:f.secret?'8px 36px 8px 12px':'8px 12px', background:'rgba(0,0,0,0.3)', border:'1px solid #1e2535', borderRadius:7, fontSize:13, color:D.text, outline:'none', fontFamily:f.mono?'monospace':'inherit', boxSizing:'border-box' }}/>
                  {f.secret && (
            ...
            <div style={{ display:'flex', gap:8, marginTop:4 }}>
              ...
              <button onClick={() => { setShowAdd(false); setForm({}) }} style={{ padding:'8px 14px', background:'transparent', border:'1px solid #1e2535', borderRadius:7, color:D.muted, fontSize:13, cursor:'pointer' }}>Cancel</button>
            </div>
          </div>
        </div>
      )}
