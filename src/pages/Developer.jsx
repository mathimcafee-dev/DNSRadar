    ...
    <div style={{ fontFamily:F, background:'#0d1117', color:'#e5e7eb', minHeight:'100vh' }}>
      ...
      <nav style={{ background:'#111827', borderBottom:'1px solid #1f2937', padding:'0 32px', height:56, display:'flex', alignItems:'center', justifyContent:'space-between', position:'sticky', top:0, zIndex:100 }}>
        <div style={{ display:'flex', alignItems:'center', gap:10, cursor:'pointer' }} onClick={() => setPage('landing')}>
          ...
          <span style={{ fontSize:10, background:'rgba(232,137,122,0.12)', color:'var(--green)', padding:'2px 8px', borderRadius:8, fontWeight:600, border:'1px solid rgba(232,137,122,0.2)' }}>Developer</span>
        </div>
      ...
      <div style={{ maxWidth:860, margin:'0 auto', padding:'60px 24px' }}>
        ...
        <div className="fade" style={{ marginBottom:56 }}>
          <div style={{ fontSize:11, fontWeight:700, color:'var(--green)', textTransform:'uppercase', letterSpacing:'0.12em', marginBottom:14 }}>Developer docs</div>
        ...
        <div className="fade" style={{ background:'#111827', border:'1px solid #1f2937', borderLeft:'4px solid var(--green)', borderRadius:'0 12px 12px 0', padding:'20px 24px', marginBottom:48 }}>
          <div style={{ fontSize:12, fontWeight:700, color:'var(--green)', marginBottom:8, textTransform:'uppercase', letterSpacing:'0.09em' }}>Why this exists</div>
...
console.log(data.issues)            // [{type:'DMARC', severity:'warn', ...}]`}/>
        ...
        <div className="fade" style={{ marginBottom:56 }}>
          ...
          <p style={{ fontSize:13, color:'var(--t3)', marginBottom:24 }}>Base URL: <code style={{ fontFamily:MONO, background:'#111827', padding:'2px 8px', borderRadius:5, color:'var(--green)' }}>{SUPABASE_URL}/functions/v1</code></p>
          {ENDPOINTS.map(ep => (
            <div key={ep.path} style={{ background:'#111827', border:'1px solid #1f2937', borderRadius:14, overflow:'hidden', marginBottom:20 }}>
              <div style={{ padding:'14px 18px', borderBottom:'1px solid #1f2937', display:'flex', alignItems:'center', gap:10 }}>
                <span style={{ fontSize:11, fontWeight:800, padding:'3px 9px', borderRadius:6, background:'rgba(232,137,122,0.12)', color:'var(--green)', fontFamily:MONO }}>{ep.method}</span>
  ...
  issues: Issue[]
        ...
        <div className="fade" style={{ textAlign:'center', padding:'40px 32px', background:'#111827', border:'1px solid #1f2937', borderRadius:16 }}>
          ...
          <div style={{ display:'flex', gap:10, justifyContent:'center', flexWrap:'wrap' }}>
            ...
            <button onClick={() => setPage('auth')} style={{ display:'inline-flex', alignItems:'center', gap:7, padding:'9px 18px', background:'var(--green)', color:'#fff', border:'none', borderRadius:8, fontSize:13, fontWeight:600, cursor:'pointer', fontFamily:F }}>
              Start building →
            </button>
          </div>
        </div>
